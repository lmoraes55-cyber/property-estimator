    ...
    <div className="min-h-screen" style={{ position: "relative", background: `radial-gradient(ellipse 800px 600px at 50% 40%, rgba(201, 167, 125, 0.25) 0%, transparent 60%), linear-gradient(135deg, rgba(255,255,255,0.88) 0%, rgba(248,244,238,0.9) 35%, rgba(253,251,247,0.94) 100%)` }}>
      ...
      <div className="print-only" id="pdf-header" style={{ display: "none", padding: "0 0 28px 0", borderBottom: "2px solid #1B5E4A", marginBottom: 28 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <p style={{ fontSize: 25, fontWeight: 600, color: "#1B5E4A", letterSpacing: "-0.01em", fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif" }}>AssetIntel</p>
      ...
      <AccessGate source="report" title="Unlock Your Full Report" subtitle="Free — enter your name and email to see your rental analysis, comparables, and recommendation.">
          ...
          <div style={{ position: "relative", zIndex: 1, padding: "28px 28px 24px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }} className="rpt-summary-wrap">
              ...
              <div style={{ borderRadius: 20, background: colors.bgWhite, border: `1px solid ${colors.border}`, borderTop: `2px solid ${colors.primary}`, padding: "22px 24px", display: "flex", flexDirection: "column", gap: 0 }} className="rpt-verdict">
                ...
                <h1 style={{ fontSize: "clamp(26px, 2.3vw, 37px)", fontWeight: 300, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", lineHeight: 1.12, letterSpacing: "-0.02em", marginBottom: 8, color: colors.textMain, textWrap: "balance" }}>
        ...
        <div className="pdf-section" style={{ background: colors.bgSection, border: "1px solid " + colors.border, borderRadius: 22, padding: "28px 28px 24px" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", fontSize: "clamp(21px, 2.1vw, 28px)", fontWeight: 400, letterSpacing: "-0.015em", color: colors.textMain, marginBottom: 4 }}>Cost &amp; Deduction Snapshot</h2>
              ...
              <div className="mb-8 pdf-section" style={{ position: "relative", overflow: "hidden", borderRadius: 28, background: "#FAFAF6", border: "1px solid #E0DBD2", boxShadow: "0 2px 6px rgba(0,0,0,0.03), 0 12px 36px rgba(27,94,74,0.07)", padding: "28px 26px 24px" }}>
                ...
                <div style={{ position: "relative", zIndex: 1, marginBottom: 20 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: 14, flexWrap: "wrap" }}>
                    <h2 style={{ fontSize: "clamp(22px, 2.2vw, 29px)", fontWeight: 400, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", letterSpacing: "-0.015em", color: colors.textMain, lineHeight: 1.2, margin: 0 }}>
                      Monthly Breakdown
                    </h2>
              ...
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 16, marginBottom: 18 }}>
                <div style={{ display: "flex", alignItems: "flex-start", gap: 14 }}>
                  ...
                  <div>
                    ...
                    <h2 style={{ fontSize: "clamp(19px, 2vw, 25px)", fontWeight: 400, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", letterSpacing: "-0.015em", color: colors.textMain, lineHeight: 1.2, margin: 0 }}>
        ...
        {ltrRecommended ? (
          ...
          >
            ...
            <h3 style={{ fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", fontSize: 25, fontWeight: 600, color: colors.primary, marginBottom: 8 }}>
...
function SavedReportGate({ savedId }: { savedId: string }) {
  ...
  if (state.status === "not-found") return (
    <div style={{ minHeight: "100vh", background: "#F7F9F8", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "12px" }}>
      <p style={{ fontSize: "17px", color: "#4E5D56", fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif" }}>This saved report could not be found.</p>
    </div>
  );
