      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "32px 16px 80px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          ...
          {activeTab === "self" && (
            <>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
                <div>
                  <h2 style={{ fontSize: 25, fontWeight: 600, margin: "0 0 6px", fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", ...gradStyle }}>Furnishing Packages by AssetIntel</h2>
              ...
              <div style={{ background: C.ivory, border: `1px solid ${C.border}`, borderRadius: 20, padding: "24px 28px", boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
                <div style={{ textAlign: "center", marginBottom: 20 }}>
                  <p style={{ fontSize: 19, fontWeight: 600, margin: "0 0 4px", fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", ...gradStyle }}>From Empty Unit to Guest-Ready</p>
          ...
          {activeTab === "self" && (
            <div style={{ background: "#FFFEFA", border: "1px solid rgba(35,93,72,0.10)", borderRadius: 24, overflow: "hidden", boxShadow: "0 8px 32px rgba(20,48,38,0.06), 0 2px 8px rgba(20,48,38,0.03)" }}>
              <div style={{ padding: "28px 32px 20px" }}>
                ...
                <p style={{ fontSize: 20, fontWeight: 600, margin: "0 0 8px", fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", ...gradStyle }}>STR Furnishing Checklist</p>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              <p style={{ fontSize: 25, fontWeight: 600, color: "#fff", margin: "0 0 8px", fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", lineHeight: 1.2 }}>Let AssetIntel Furnish Your Property</p>
