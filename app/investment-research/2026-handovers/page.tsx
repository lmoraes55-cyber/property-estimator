    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "16px 28px", marginBottom: 26, paddingBottom: 26, borderBottom: `1px solid ${colors.border}` }}>
        <div>
          ...
          <p style={{ fontSize: 18, fontWeight: 600, color: colors.textMain, fontFamily: serif }}>{quarterOf(project.project_end_date)}</p>
        </div>
        <div>
          ...
          <p style={{ fontSize: 18, fontWeight: 600, color: colors.textMain, fontFamily: serif }}>{project.area_name_en}</p>
        </div>
        {project.percent_completed != null && (
          <div>
            ...
            <p style={{ fontSize: 18, fontWeight: 600, color: colors.textMain, fontFamily: serif }}>{project.percent_completed.toFixed(0)}% complete</p>
          </div>
        )}
        {project.no_of_units != null && project.no_of_units > 0 && (
          <div>
            ...
            <p style={{ fontSize: 18, fontWeight: 600, color: colors.textMain, fontFamily: serif }}>{project.no_of_units.toLocaleString()}</p>
          </div>
        )}
      </div>
            ...
            <>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "16px 28px", marginBottom: 18 }}>
                <div>
                  ...
                  <p style={{ fontSize: 18, fontWeight: 600, color: colors.textMain, fontFamily: serif }}>AED {saleStat.medianPrice.toLocaleString()}</p>
                </div>
                <div>
                  ...
                  <p style={{ fontSize: 18, fontWeight: 600, color: colors.textMain, fontFamily: serif }}>AED {saleStat.medianAedPerSqft.toLocaleString()}</p>
                </div>
                <div>
                  ...
                  <p style={{ fontSize: 18, fontWeight: 600, color: colors.textMain, fontFamily: serif }}>{saleStat.n}</p>
                </div>
                <div>
                  ...
                  <p style={{ fontSize: 18, fontWeight: 600, color: colors.textMain, fontFamily: serif }}>{Math.round(saleStat.offPlanShare * 100)}%</p>
                </div>
              </div>
...
function ProjectCard({ project, onClick }: { project: DLD2026Handover; onClick: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div>
        <h3 style={{ fontSize: 17, fontWeight: 600, color: colors.textMain, marginBottom: 3, lineHeight: 1.3, fontFamily: serif }}>
          {displayName(project)}
        </h3>
      ...
      >
        ...
        {submitted ? (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <h3 style={{ fontFamily: serif, fontSize: 25, fontWeight: 600, color: colors.primary, marginBottom: 12 }}>Enquiry Received</h3>
          ...
          <>
            ...
            <h2 style={{ fontFamily: serif, fontSize: 25, fontWeight: 600, color: colors.primary, lineHeight: 1.25, marginBottom: 24 }}>
