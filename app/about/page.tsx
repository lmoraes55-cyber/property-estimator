      ...
      <main style={{ color: C.text, position: "relative" }}>
        ...
        <section style={{ padding: "72px 24px", borderTop: `1px solid ${C.borderSage}` }}>
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            ...
            <h2 style={{ fontSize: "clamp(24px, 3vw, 38px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: C.text, marginBottom: 32, lineHeight: 1.2 }}>Why We Built AssetIntel</h2>
        ...
        <section style={{ padding: "72px 24px", borderTop: `1px solid ${C.border}` }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <h2 style={{ fontSize: "clamp(22px, 3vw, 36px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: C.text, marginBottom: 40, lineHeight: 1.2 }}>Built On Real Short-Term Rental Operating Knowledge</h2>
        ...
        <section style={{ padding: "72px 24px", borderTop: `1px solid ${C.border}` }}>
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            ...
            <h2 style={{ fontSize: "clamp(22px, 3vw, 36px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: C.text, marginBottom: 20, lineHeight: 1.2 }}>From Smaller Portfolios To Large-Scale STR Operations</h2>
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 48, alignItems: "start" }}>
              ...
              <div>
                ...
                <h2 style={{ fontSize: "clamp(22px, 3vw, 34px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: C.text, marginBottom: 20, lineHeight: 1.2 }}>STR Sub-Leasing Setup Experience</h2>
        ...
        <section style={{ background: C.green, padding: "72px 24px", borderTop: `1px solid rgba(255,255,255,0.08)` }}>
          <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center" }}>
            ...
            <h2 style={{ fontSize: "clamp(24px, 3vw, 40px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: "#fff", marginBottom: 16, lineHeight: 1.2 }}>Independent Guidance Before You Commit</h2>
        ...
        <section style={{ padding: "80px 24px", borderTop: `1px solid ${C.border}` }}>
          <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
            ...
            <h2 style={{ fontSize: "clamp(24px, 3.5vw, 42px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: C.text, marginBottom: 16, lineHeight: 1.2 }}>
