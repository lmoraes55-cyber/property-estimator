      ...
      <div style={{ background: C.bgSection, borderRadius: 24, padding: "36px 32px", width: "100%", maxWidth: 460, boxShadow: "0 24px 60px rgba(0,0,0,0.18)", border: `1px solid ${C.border}`, position: "relative" }}>
        ...
        {sent ? (
          ...
          <>
            ...
            <h3 style={{ fontSize: 22, fontWeight: 600, color: C.text, marginBottom: 6, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif" }}>Get in touch</h3>
      ...
      <main style={{ color: C.text, position: "relative" }}>
        ...
        <section style={{ padding: "72px 24px", borderTop: `1px solid ${C.borderSage}` }}>
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            ...
            <h2 style={{ fontSize: "clamp(27px, 3vw, 43px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: C.text, marginBottom: 32, lineHeight: 1.2 }}>Why We Built AssetIntel</h2>
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <p style={{ fontSize: 19, fontWeight: 600, color: C.green, lineHeight: 1.65, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", fontStyle: "italic", marginTop: 8 }}>
        ...
        <section style={{ padding: "72px 24px", borderTop: `1px solid ${C.border}` }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <h2 style={{ fontSize: "clamp(25px, 3vw, 40px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: C.text, marginBottom: 40, lineHeight: 1.2 }}>Built On Real Short-Term Rental Operating Knowledge</h2>
        ...
        <section style={{ padding: "72px 24px", borderTop: `1px solid ${C.border}` }}>
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            ...
            <h2 style={{ fontSize: "clamp(25px, 3vw, 40px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: C.text, marginBottom: 20, lineHeight: 1.2 }}>From Smaller Portfolios To Large-Scale STR Operations</h2>
            ...
            <div style={{ position: "relative", paddingLeft: 36 }}>
              ...
              {[
                ...
                <div key={stage.label} style={{ position: "relative", paddingBottom: i < 2 ? 40 : 0 }}>
                  ...
                  <p style={{ fontSize: 19, fontWeight: 600, color: C.green, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", marginBottom: 3 }}>{stage.label}</p>
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 48, alignItems: "start" }}>
              ...
              <div>
                ...
                <h2 style={{ fontSize: "clamp(25px, 3vw, 38px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: C.text, marginBottom: 20, lineHeight: 1.2 }}>STR Sub-Leasing Setup Experience</h2>
                ...
                <p style={{ fontSize: 17, color: C.textMuted, lineHeight: 1.65, fontStyle: "italic", fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif" }}>
        ...
        <section style={{ padding: "72px 24px", borderTop: `1px solid ${C.border}` }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <h2 style={{ fontSize: "clamp(25px, 3vw, 40px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", textAlign: "center", marginBottom: 48, color: C.text }}>What AssetIntel Helps You Decide</h2>
        ...
        <section style={{ background: C.green, padding: "72px 24px", borderTop: `1px solid rgba(255,255,255,0.08)` }}>
          <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center" }}>
            ...
            <h2 style={{ fontSize: "clamp(27px, 3vw, 45px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: "#fff", marginBottom: 16, lineHeight: 1.2 }}>Independent Guidance Before You Commit</h2>
        ...
        <section style={{ padding: "80px 24px", borderTop: `1px solid ${C.border}` }}>
          <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
            ...
            <h2 style={{ fontSize: "clamp(27px, 3.5vw, 47px)", fontWeight: 600, fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", color: C.text, marginBottom: 16, lineHeight: 1.2 }}>
