    ...
    <div style={{ minHeight: "100vh", background: C.bgMain, overflowX: "hidden" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", isolation: "isolate" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 1152, margin: "0 auto", padding: "64px 24px 72px" }}>
          <div style={{ maxWidth: 760 }}>
            ...
            <h1 style={{ fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", fontSize: 45, color: C.primary, marginBottom: 16, lineHeight: 1.2, maxWidth: 620 }}>
        ...
        {estimate && (
          ...
          <div style={{ marginTop: 24, maxWidth: 680, background: C.bgWhite, border: `1px solid ${C.borderSage}`, borderRadius: 16, padding: 28, boxShadow: C.shadowLg }}>
            ...
            <div style={{ fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", fontSize: 40, color: C.primary, marginBottom: 4 }}>
      ...
      <section style={{ maxWidth: 1152, margin: "0 auto", padding: "64px 24px 96px" }}>
        <div style={{ textAlign: "center", maxWidth: 640, margin: "0 auto 44px" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", fontSize: 34, color: C.primary, lineHeight: 1.3 }}>
            How The LTR Estimate Works
          </h2>
        </div>
          ...
          {[
            ...
            <div key={card.title}
              ...
              <div style={{
                ...
                fontFamily: "var(--font-display), ui-sans-serif, system-ui, sans-serif", fontSize: 17, fontWeight: 600, color: C.primary,
              }}>
                {i + 1}
              </div>
