    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
        ...
        <tr><td style="padding:32px 40px 0;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#F8F4EE;border-radius:12px;padding:20px;">
            <tr><td style="padding:0 4px 12px;">
              <p style="margin:0 0 3px;font-size:11px;color:#6B6B6B;text-transform:uppercase;letter-spacing:1px;font-weight:600;">Furniture Package</p>
              <p style="margin:0;font-size:15px;font-weight:700;color:#1A1A1A;">${fmt(pkgInfo.lo)} – ${fmt(pkgInfo.hi)}</p>
            </td></tr>
            <tr><td style="padding:0 4px 12px;border-top:1px solid #E6E1D8;padding-top:12px;">
              <p style="margin:0 0 3px;font-size:11px;color:#6B6B6B;text-transform:uppercase;letter-spacing:1px;font-weight:600;">AssetIntel Setup & Coordination Fee</p>
              <p style="margin:0;font-size:15px;font-weight:700;color:#1A1A1A;">${fmt(setupFee)} <span style="font-weight:400;color:#6B6B6B;font-size:12px;">(based on ${unitSize || "unit"} size)</span></p>
            </td></tr>
            <tr><td style="padding:0 4px;border-top:1px solid #E6E1D8;padding-top:12px;">
              <p style="margin:0 0 4px;font-size:11px;color:#6B6B6B;text-transform:uppercase;letter-spacing:1px;font-weight:600;">Estimated Total</p>
        ...
        <tr><td style="padding:24px 40px 0;">
          <p style="margin:0 0 10px;font-size:12px;font-weight:700;color:#1A1A1A;text-transform:uppercase;letter-spacing:1px;">What AssetIntel Coordinates</p>
