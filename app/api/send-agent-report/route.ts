    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
        ...
        <tr><td style="background:linear-gradient(135deg,#1B5E4A 0%,#0F3E33 100%);padding:32px 40px;">
          <p style="margin:0;color:#B88A44;font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase;">AssetIntel · Agent Report</p>
          <h1 style="margin:8px 0 0;color:#fff;font-size:22px;font-weight:700;font-family:Georgia,serif;">${reportType}</h1>
          <p style="margin:6px 0 0;color:rgba(255,255,255,0.7);font-size:13px;">${propertyLabel}${agencyName ? ` · ${agencyName}` : ""}</p>
        </td></tr>
