            ...
            <tr>
              <td style="padding:0 8px 12px 0;width:50%;vertical-align:top;">
                <div style="background:#F8F4EE;border-radius:10px;padding:16px;">
                  ...
                  <p style="margin:0;font-size:12px;color:#6B6B6B;line-height:1.5;">Compare STR vs LTR returns for your exact unit.</p>
                </div>
              </td>
              <td style="padding:0 0 12px 8px;width:50%;vertical-align:top;">
                <div style="background:#F8F4EE;border-radius:10px;padding:16px;">
                  ...
                  <p style="margin:0;font-size:12px;color:#6B6B6B;line-height:1.5;">Live Dubai STR market data and investment research.</p>
                </div>
              </td>
            </tr>
            <tr>
              <td style="padding:0 8px 0 0;vertical-align:top;">
                <div style="background:#F8F4EE;border-radius:10px;padding:16px;">
                  ...
                  <p style="margin:0;font-size:12px;color:#6B6B6B;line-height:1.5;">All your property reports in one place, always accessible.</p>
                </div>
              </td>
              <td style="padding:0 0 0 8px;vertical-align:top;">
                <div style="background:#F8F4EE;border-radius:10px;padding:16px;">
                  ...
                  <p style="margin:0;font-size:12px;color:#6B6B6B;line-height:1.5;">Furnishing, legal, operator matching, and more.</p>
                </div>
              </td>
            </tr>
          </table>
